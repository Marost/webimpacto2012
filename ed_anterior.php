...
$rst_edimpresa        = mysql_query("SELECT COUNT(*) as count FROM iev_edicion WHERE fecha_publicacion<='$fechaActual' ORDER BY fecha_publicacion DESC", $conexion);
...
$rst_edimpresa        = mysql_query("SELECT * FROM iev_edicion WHERE fecha_publicacion<='$fechaActual' ORDER BY fecha_publicacion DESC LIMIT $start, 25", $conexion);
...
<title>Ediciones anteriores | Impacto Evangelístico</title>
  	...
  	<div id="cuerpo">
        <div id="panel_edicion_anterior">
            ...
            <div class="pedantcont_item">
              <a href="revista/<?php echo $edimpresa_numero; ?>/index.html" target="_blank" title="<?php echo $edimpresa_nombre; ?>">

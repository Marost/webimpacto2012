...
$rst_edimpresa        = mysql_query("SELECT COUNT(*) as count FROM iev_edicion_fr WHERE fecha_publicacion<='$fechaActual' ORDER BY fecha_publicacion DESC", $conexion);
...
$rst_edimpresa        = mysql_query("SELECT * FROM iev_edicion_fr WHERE fecha_publicacion<='$fechaActual' ORDER BY fecha_publicacion DESC LIMIT $start, 25", $conexion);
...
<title>Edition Francais | Impacto Evangelístico</title>
